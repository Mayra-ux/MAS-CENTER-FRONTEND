...
import { newBlogErizo, updateBlogErizo } from '../../actions/blogErizo';
...
export const EditModal = () => {
    ...
    let activeDoc = useSelector(state => state.erizo.activeDoc);
    ...
    const handleSubmitForm = (e) => {
        ...
        if(activeDoc ===null){
            dispatch(newBlogErizo(date, image));
            
        }else{
            dispatch(updateBlogErizo(activeDoc.date, image, activeDoc.id));
