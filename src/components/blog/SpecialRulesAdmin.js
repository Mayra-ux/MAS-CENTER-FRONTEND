...
import {getBlogSpecialRules,newBlogSpecialRules,updateBlogSpecialRules,deleteBlogSpecialRules} from '../../actions/blogSpecialRules';
import { uiCloseModalSpecialRules, uiOpenModalDoc, uiOpenModalSpecialRules } from '../../actions/ui';
import { useForm } from '../../hooks/useForm';
import { EditModal } from '../../components/blog/EditModalSpecial';
import {docSetActive} from '../../actions/blogErizo';

export const SpecialRulesAdmin = ({history}) => {
    ...
    useEffect(() => {
        dispatch(getBlogSpecialRules());
    }, [dispatch])
    
    let bS= useSelector(state => state.special.special)
    console.log(bS); // add Mayra
    ...
    const handlerFilterSpecial = function(e){
    ...
    const handleDelete = (e) =>{
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(deleteBlogSpecialRules(temp.id));
        ...
        <hr />
            <div className="container-fliud center text-center">
                ...
                {(role==="Admin" || role==="PD Admin")&&
                    <div>
                         <h1 className="text-center" style={{ color: '#ffffff' }}>SPECIAL RULES</h1>
                ...
                <div className="row ">
                    <div className="col-4 mt-2">
                        ...
                        <form onSubmit={handleSearch2}>
                            ...
                            {/* <select className="form-control mt-2" name="year" onChange={blogSpecialFind}>
                                <option selected>Select Year</option>
                                <option value="2021"> 2021 </option>
                                <option value="2022"> 2022 </option>
                            </select> */}
                            <select className="form-control mt-2" name="month" onChange={handlerFilterSpecial}>
                    ...
                    <div className="col-8 container animate__animated animate__fadeIn mt-2">
                        ...
                        <hr />
                        {(bS.length !== 0)&&
                         bS.map(doc =>(doc.date.substr(0,10)===dateImage&&
