...
import {getBlogSpecialRules} from '../../actions/blogSpecialRules';
    ...
    return(
        ...
        <div className="animate__animated animate__fadeIn container mt-2 col-lg-12 col-md-12 col-sm-12 mx-auto">
                ...
                <div className='row'>
                    <div className='col-lg-12 col-md-12 col-sm-12' >
                        ...
                        <nav aria-label="breadcrumb" style={{ backgroundColor : "#283040"}}>
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Reglas Especiales</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class = "mx-auto my-1">
                        ...
                        <select className="form-control" name="date" onChange={ handlerFilterSpecial }>
            ...
            {(bS.length !== 0)&&bS.map(special=>(  special.date.substr(0,10)===dateImage&&
                    <>
