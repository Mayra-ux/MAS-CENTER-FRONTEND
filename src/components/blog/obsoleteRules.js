...
import {getBlogObsoleteRules} from '../../actions/blogObsoleteRules'
//---------------------------------------------------

export const Obsolete = () =>{
//--------------------------- código para generar la consulta-------
        ...
        <div className='row'>
            <div className='col-lg-12 col-md-12 col-sm-12' >
                    ...
                    <nav aria-label="breadcrumb" style={{ backgroundColor : "#283040"}}>
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Reglas Obsoletas</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<div className='col-lg-2 col-md-2 col-sm-2 row mt-1 h-100'>
    ...
    <div class = "mx-auto my-1">
                        ...
                        <select className="form-control" name="date" onChange={ handlerFilterObsolete }>
...
<div className="col-lg-10 col-md-10 col-sm-10 row my-1">
    {(bO.length !== 0)&&bO.map(obsolete=>( obsolete.date.substr(0,10)===dateImage&&
