...
import { newDash, updateDash } from '../../actions/dash';
...
export const EditModal = () => {
    ...
    const handleSubmitForm = (e) => {
        ...
        if(formValues.name === "" || formValues.image === ""){
            ...
            if(activeDoc ===null){
                dispatch(newDash(formValues.name, image));
                
            }else{
                dispatch(updateDash(formValues.name, image, activeDoc.id));
    ...
    return (
        <Modal
            ...
            <div>
                <h1 className="text-center"> New Dashboard</h1>
                <hr />
